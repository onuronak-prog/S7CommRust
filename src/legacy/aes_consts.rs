...
// AUTO-GENERATED from HarpoS7 Aes/AesConsts.cs (MIT, (c) 2024 bonk). Do not edit by hand.

/// The 512-byte LUT seed. Also serves as the hash seed when viewed as little-endian u16.
pub static LUT_SEED: [u8; 512] = [
