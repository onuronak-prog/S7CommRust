...
// (MIT) HarpoS7.Family0/Monolith7liths/Monolith7.cs by scratchpad/convert_named.ps1: a
// straight-line named-local circuit (only ^ & ~(->!) >> << *2(-><<1)). Validated
// byte-for-byte against the Monolith7-src/dst golden vector. See LICENSE-HarpoS7.
#![allow(clippy::all)]
#![allow(
    non_snake_case,
    unused_parens,
...
pub fn execute(destination: &mut [u8], source: &[u8]) {
    ...
    uVar37 =
        ((uVar1 & 0x7130051a ^ uVar68 & 0x5022002e ^ 0x10020508) & uVar10 ^ 0x2110003a) & uVar30;
    ...
    uVar100 = ((((uVar30 & 0x5aa5b729 ^ uVar10 & 0x8ccd4ac0 ^ 0x47f8c9d1) & uVar1
        ...
        ^ 0x7132053e)
        & uVar35
        ^ ((((uVar1 & 0x5aa5b729 ^ 0x6b55e7da) & uVar13 ^ uVar1 & 0x5aa5b729 ^ 0x6b55e7da)
            & uVar10
            ^ 0xa15070da)
            & uVar30
            ...
            ^ 0xfbf5f7db)
            & uVar68
        ^ ((uVar30 & 0xa310803a ^ uVar100 ^ 0x200008) & uVar13
            ^ uVar30 & 0xa310803a
            ^ uVar100
            ^ 0x200008)
            & uVar10;
    ...
    uVar82 = (((((uVar69 ^ 0x21100050) & 0xa15040f2 ^ uVar10 & 0xdcce4aa6) & uVar24
        ^ (uVar10 & 0xf9d547d2 ^ 0x81103038) & src[7]
        ^ uVar10 & 0x94830500
        ^ 0xa1102032)
        & uVar13
        ^ 0x2110003a)
        ...
        ^ ((!(src[7] & 0xa371f5fb) & !uVar13 & uVar10 ^ 0xa15070da) & src[8]
            ^ ((uVar69 ^ 0xa370f0fb) & uVar13 ^ src[7] ^ 0x58850720) & uVar10
            ^ 0xfbf5f7db)
            & uVar24
    ...
    uVar56 = ((((uVar39 ^ 0x11dc03a) & src[9] ^ (uVar39 ^ 0x11cc02a) & 0x111cdeab) & 0xdbbfffff
        ^ (uVar39 ^ 0x2055c03a) & src[0xb] & 0xbcf7dfbf)
        & src[10]
        ^ (!(uVar39 & 0x100402a) & 0x1ba069ee
            ^ src[10] & uVar83
            ^ uVar94 & src[0xb]
            ^ src[9] & uVar71)
            & uVar81
        ^ ((uVar39 ^ 0x215d0002) & src[0xb] & 0xe7ff3947 ^ (uVar39 ^ 0x205cc03a) & 0xa4fec13e)
            & src[9]
        ^ (src[0xb] & 0xdea23fc5 ^ 0x1ba069ee) & uVar39
        ^ 0xdfa27fef)
        & uVar12
    ...
    uVar44 = ((((uVar10 & 0x71120536 ^ uVar30 & 0xfbf5f7db ^ 0xba278627) & uVar1
        ...
        & uVar68
        ^ ((uVar30 & 0x7130051a ^ 0x30200426) & uVar1 ^ !(uVar30 & 0x10020508) & 0x7132053e)
            & !uVar10)
        & uVar13
        ^ uVar38
        ^ uVar37)
    ...
    uVar45 = ((uVar83 & uVar12 ^ uVar20 & 0x1ba069ee) & uVar81 ^ src[0xb] & 0xbcf7dfbf ^ uVar93)
        & src[10]
        ^ ((uVar94 & uVar12 ^ uVar24 & 0x3a02946 ^ 0x1aa029c4) & uVar81
            ^ uVar51 & 0xe7ff3947
            ^ 0xdea23fc5)
            & src[0xb]
        ^ (!(!(uVar81 & 0xc4021601) & uVar12) ^ uVar81) & uVar39
        ^ ((uVar71 & uVar12 ^ 0xa0412e) & uVar81 ^ 0xa4fec13e) & src[9]
        ^ uVar12
        ^ 0x1ba069ee;
    uVar93 = !(uVar59 & 0xfaedafff) & src[0x11];
    uVar69 = src[0x14];
    uVar51 = src[0x11];
    uVar72 = (!uVar59 & src[0x10] & 0xfaedafff ^ !uVar59 & 0x51050151 ^ uVar93 & 0xef9fd0fb)
        & uVar23
    ...
    uVar61 = (((uVar34 & 0x38550682 ^ 0x9ca21f85) & uVar37
        ...
        ^ 0x10001e81)
        & uVar43
        ^ ((uVar34 & 0x215d0002 ^ 0xc6a23945) & uVar38 ^ !(uVar34 & 0x18000680) & 0xdea23fc5)
            & uVar37
    ...
    uVar87 = !(((uVar94 & uVar8 ^ uVar34 & 0xe4430010 ^ 0x1c1011) & uVar43
        ...
        ^ 0xe7ff3947)
        & uVar71)
        ^ ((uVar95 & uVar34 ^ 0xc4021601) & uVar43
            ^ (uVar37 & uVar34 ^ 0x10001e81) & src[0xb]
            ^ 0xdea23fc5)
            & uVar4
        ^ (uVar95 & uVar43 ^ uVar37 & src[0xb]) & uVar34;
    uVar37 = uVar23 & (uVar51 ^ 0x1000000);
    uVar8 = (uVar15 ^ 0x5125000) & src[0x11];
    uVar43 = (uVar51 & 0xfeefefff ^ uVar37 ^ uVar101 ^ 0xffedafff) & uVar18;
    uVar88 = !((((src[0x10] & 0xfaedafff ^ 0x51050151) & uVar15
        ^ (uVar8 ^ 0x1000000) & 0xef9fd0fb)
        & src[0xf]
        ^ ((uVar8 ^ 0x4125000) & 0xfd77ffcf ^ uVar15 & 0x861ada74) & src[0x10]
        ^ (uVar15 ^ 0x4024000) & src[0x11] & 0xc4e7ee05
    ...
    uVar102 = (((uVar32 & 0xc487c001 ^ 0xed17d0cb) & src[0x11]
        ...
        ^ ((!(uVar32 & 0xc6efee35) & src[0x11] ^ uVar32 & 0x868aca34 ^ 0x7965258b) & uVar8
            ^ 0x1d61248f)
            & 0xfd77ffcf
        ^ ((uVar32 ^ 0xff7fffff) & src[0x11] ^ uVar32 & 0xfb1edbfa) & 0xc4e7ee05)
        & uVar36
        ^ ((((uVar8 & 0x388001ca ^ src[0x11] & 0x299010ca ^ 0x11000140) & src[0xf]
            ^ ((src[0x11] ^ 0x101040) & uVar8 ^ 0xe6ffff75) & 0x391011ca
            ^ src[0x11] & 0x800000)
            & uVar32
            ^ 0xf865afcf)
            & uVar36
    ...
    uVar64 = !uVar46;
    uVar65 = (!((((!(uVar26 & 0xc7f7e717) & uVar37 ^ 0x9181846) & 0xb9181aef
        ^ uVar26 & 0x3918387e)
        & uVar27
        ...
        ^ (!(uVar26 & uVar64 & 0xc7f7e717) & uVar37 & 0xb9181aef
            ^ (uVar46 & 0x2214 ^ 0x7fffdd6e) & uVar26
            ^ 0xdffdd46)
            & uVar27
        ...
        ^ 0x85162217;
    uVar75 =
        (((!((!uVar71 ^ uVar4) & uVar39) ^ uVar71 ^ uVar4) & uVar12 ^ !uVar39 & uVar71 ^ uVar4)
            & uVar34
    ...
    uVar8 = ((!(uVar67 & 0xe7fff97f) & uVar43 ^ uVar67 & 0xa5ffc13e ^ 0x1aa029c4) & 0xdea23fc5
        ...
        ^ ((uVar20 & src[10] ^ src[9] & 0xa0412e) & 0x1ba069ee
            ^ (uVar24 & 0x3a02946 ^ 0x1aa029c4) & uVar43)
            & uVar81;
    uVar20 =
        ((uVar38 & 0xf543ceaa ^ 0xddaa5faf) & uVar43 ^ uVar67 & 0xbffee9fe ^ 0xf55fdebb) & uVar34;
    uVar43 = (uVar67 & 0xe6ffe16e ^ 0xcebeb745) & uVar34;
    uVar24 = src[0x10];
    uVar97 = (((uVar38 & uVar94 & 0xf543ceaa ^ uVar34 & 0xddaa5faf ^ 0x795d46a8) & src[0xb]
        ^ (uVar34 & 0xbffee9fe ^ 0x7c41d0b9) & src[9]
        ^ (uVar34 ^ 0x101cd6b9) & 0xf55fdebb)
        & src[10]
        ^ ((uVar34 & 0xe6ffe16e ^ 0x100d829) & uVar67 ^ uVar34 & 0xcebeb745 ^ 0x9009603)
            & src[0xb]
    ...
    uVar77 = ((((uVar80 & 0x37bf9913 ^ 0x27029007) & uVar31 ^ (uVar80 ^ 0x29002) & 0xa69906)
        & uVar29
        ...
        & uVar54
        ^ ((((uVar80 & 0x37bf9913 ^ 0xaf425123) & uVar29 ^ uVar63) & uVar22
            ^ uVar54 & 0xbf1e5531
            ^ 0x98fd0910)
            & uVar31
            ^ uVar76)
    ...
    uVar90 = !((((uVar28 & (uVar69 ^ 0x497206a9) ^ uVar69 & 0xdfa4c1b) & uVar25
        ^ uVar19 & 0x4ce90e37
        ^ 0xb316f1c8)
        & 0xddfb5eff
    ...
    uVar49 = !uVar42;
    uVar18 = !((((uVar38 ^ uVar10) & uVar35 ^ uVar38 & uVar10) & uVar13
        ^ (!uVar35 ^ uVar50) & uVar10)
        & uVar24)
        & uVar42
    ...
    uVar105 = ((!(uVar93 & uVar79) ^ uVar19 & uVar99) & uVar41
        ^ (uVar93 & uVar67 ^ uVar60 ^ uVar105 ^ 0xffff1e3f) & uVar19)
        & uVar9
        ...
        ^ 0x951f183e;
    uVar81 =
        (!((!(uVar71 & uVar91) ^ uVar39 ^ uVar12) & uVar4) ^ uVar71 ^ uVar39 ^ uVar12 ^ uVar81)
            & uVar34
    ...
    uVar79 = ((((uVar50 & 0x32e0c4c3 ^ 0xc80c3a2c) & uVar1
        ...
        ^ 0x9683a508)
        & uVar30
        ^ (((uVar1 ^ 0xef77f3fb) & uVar68 & 0xfddf7ffe ^ uVar1 ^ 0x2c8c8c1)
            & uVar49
            & uVar50
            & 0x32e8cce7
            ^ uVar42)
    ...
    uVar16 = (!(!((uVar17 ^ uVar99) & uVar83) & uVar53) ^ uVar17 ^ uVar99 ^ uVar3) & uVar14
        ...
        ^ uVar17
        ^ uVar99;
    uVar40 = (((uVar70 ^ uVar40) >> 0x12 & uVar7 ^ uVar19 ^ uVar41) & uVar9
        ^ uVar86 & uVar19
        ^ uVar41
        ^ uVar11)
        & uVar52
    ...
    uVar70 = (!((((uVar25 ^ uVar7) & uVar52 ^ uVar86 & uVar19) & uVar9 ^ uVar19 & uVar63)
        & uVar41)
    ...
    uVar53 = ((((uVar80 & 0x44a71ac6 ^ 0x9c1ab1da) & uVar31 ^ uVar80 & 0x101c81d6 ^ 0x1018a0da)
        ...
        ^ !((((uVar31 & 0x63404621 ^ uVar80 & 0x67a31a01 ^ 0x44021600) & uVar29
            ...
            & uVar17
            ^ ((uVar80 & 0x44a71ac6 ^ 0x771a36df) & uVar31 ^ uVar80 & 0x771902d1 ^ 0x541826d8)
                & uVar29
    ...
    uVar67 = !(((((uVar101 ^ 0x46e7c704) & uVar26 ^ 0x4e7c500) & uVar27
        ...
        & uVar6
        ^ ((uVar64 & uVar37 & 0x81100207 ^ uVar46 & 0x7fffdd6e ^ 0x46e7c704) & uVar26
            ^ uVar67 & uVar46
            ^ 0x4e7c500)
            & uVar27
    ...
    uVar60 = !((!((uVar92 ^ uVar23) & uVar8) ^ uVar45 ^ uVar92) & uVar75)
        ...
        ^ uVar8;
    uVar66 = !(((((uVar52 & 0x941f183a ^ 0x9016b188) & uVar7
        ^ uVar69 & uVar63 & 0x9c9b18bb
        ^ 0x9016b188)
        & uVar28
        ...
        & uVar11)
        ^ ((uVar28 & 0x9c9b18bb ^ 0xd9631629) & uVar93 ^ uVar28 & 0x81240ed ^ 0x458b0afa)
            & uVar86
            & uVar69
            & uVar52
        ^ uVar7 & 0x409e9f6;
    ...
    uVar12 = ((uVar49 & uVar50 ^ uVar64 ^ 0xfd37373e) & 0x32e8cce7
        ^ (uVar42 & 0xdeeefaaf ^ 0x12808400) & uVar30
        ^ uVar76)
        & uVar24
    ...
    uVar34 = ((uVar91 ^ uVar78) & (uVar74 ^ uVar102) ^ uVar74 ^ uVar102) & uVar55
        ^ !((uVar74 ^ uVar102) & uVar91) & uVar78
        ^ uVar102;
    uVar8 = !uVar97;
    uVar94 = !uVar87;
    uVar26 =
        ((uVar94 ^ uVar60) & uVar97 ^ !((uVar8 ^ uVar60) & uVar81) ^ (uVar97 ^ uVar87) & uVar62)
            & uVar25
            ^ (!uVar81 & uVar60 ^ uVar94 & uVar62 ^ uVar87) & uVar97
            ^ uVar62
            ^ uVar60;
    uVar37 = !(!((uVar67 & uVar65) >> 1) & uVar6 >> 1) ^ uVar65 >> 1;
    uVar43 = (uVar28 & 0xbe9fb9bb ^ uVar69 & 0xff6effdf ^ 0xd9f2b709) & uVar93
        ^ uVar69 & 0xf09012c4
        ^ uVar43;
    ...
    uVar50 = ((((uVar50 & 0x30c84ce6 ^ uVar23) & uVar1 & 0xfddf4ff6
        ...
        & uVar68
        ^ ((!(uVar50 & 0xfee6f6cb) & uVar30 ^ uVar38 & 0xfeeefeef) & uVar1 ^ uVar50 & 0x2c8c8c1)
            & 0x33f9cdf7
        ...
        ^ ((!(uVar30 & 0xdeefffaf) & 0xa15070fa ^ uVar1 & uVar23 & 0xfddf4ff6) & uVar68
            ...
            & uVar38)
        & uVar42
        ^ (!(uVar23 & uVar50) & uVar1 & 0xfddf4ff6
            ^ !(uVar50 & 0xa15175fa) & uVar30 & 0xdeeefaaf
            ^ uVar38 & 0xa15070fa)
            & uVar68
        ^ ((uVar50 & 0x33f9cdf7 ^ 0xfbf5f7db) & uVar30 ^ uVar38 & 0x32e8cce7) & uVar1
        ^ (((uVar30 & 0x12808400 ^ uVar64 ^ 0x2c8c8c1) & 0x32e8cce7 ^ uVar76) & uVar50
            ^ 0x32e8cce7)
            & uVar24
    ...
    uVar27 = !((!((uVar97 ^ uVar87 ^ uVar81 ^ uVar60) & uVar25)
        ^ (uVar8 ^ uVar87 ^ uVar81) & uVar60)
        & uVar62)
    ...
    uVar41 = ((((uVar7 & 0xd57f5e7e ^ !uVar51) & uVar28 & 0xbe9fb9bb
        ...
        & uVar93
        ^ (!(uVar7 & 0xbd1f58ff) & 0xd7edbf12 ^ (uVar7 & 0x951b183e ^ 0xd5e91e12) & uVar69)
            & uVar28
    ...
    uVar94 = !(!((uVar12 ^ uVar35 ^ uVar10) & uVar79) & uVar13)
        ^ (uVar9 ^ uVar13) & uVar50 & uVar12
        ^ uVar10;
    uVar80 = ((((uVar3 & 0x63404621 ^ 0xc8000704) & uVar54
        ^ uVar22 & uVar80 & 0x731883d5
        ^ 0xc8000704)
        & uVar31
    ...
    uVar54 = (uVar17 & (uVar43 ^ uVar54) ^ uVar96) & uVar89
        ^ (!uVar89 ^ uVar17) & uVar54 & uVar3
        ^ uVar96 & uVar17
        ^ uVar59;
    ...
    uVar101 = (uVar50 & uVar12 ^ uVar13 & uVar35) & (uVar79 ^ uVar10)
        ...
        ^ uVar13;
    uVar74 = !((!((uVar102 ^ uVar91) & uVar55)
        ^ (uVar102 ^ uVar58) & uVar74
        ^ (uVar91 ^ uVar58) & uVar102
        ^ uVar91
        ^ uVar58)
        & uVar78)
    ...
    uVar29 = (!uVar80 ^ uVar77) & (uVar24 ^ uVar92) & uVar63
        ^ (!uVar92 ^ uVar53) & uVar80
        ^ (uVar92 ^ uVar53) & uVar77
        ^ uVar24
        ^ uVar92
        ^ uVar53;
    uVar25 = (!((uVar8 ^ uVar25) & uVar60)
        ^ (uVar60 ^ uVar25) & uVar81
        ^ (uVar8 ^ uVar60) & uVar87
        ^ uVar97
        ^ uVar25)
        & uVar62
    ...
    uVar45 = ((uVar18 ^ uVar57) & uVar12 ^ uVar18 ^ uVar57) & uVar79
        ^ (uVar12 ^ uVar79) & uVar50 & (uVar18 ^ uVar57)
        ^ uVar12
        ^ uVar57;
    ...
    uVar39 = !(((!uVar103 ^ uVar105 ^ uVar90) & uVar70 ^ !uVar90 & uVar105 ^ uVar103 ^ uVar40)
        ...
        ^ uVar105;
    uVar40 = ((uVar5 ^ uVar32) & uVar72 ^ uVar5 ^ uVar32) & uVar88
        ^ !(uVar84 & uVar5) & uVar36
    ...
    uVar3 = uVar54 ^ uVar42;
    uVar67 = uVar3 >> 1;
    uVar18 = ((uVar11 ^ uVar7) & uVar93 ^ uVar105 ^ uVar90) & uVar47
        ^ (!uVar90 ^ uVar52) & uVar7
        ^ (uVar90 ^ uVar52) & uVar11
        ^ uVar90;
    ...
    uVar7 = !((!((!((!((!uVar31 ^ uVar56) & uVar1) ^ uVar43) & uVar37)
        ^ !uVar43 & uVar1
        ^ uVar31
        ^ uVar56)
        & uVar87
    ...
    uVar49 = ((!(((!(uVar86 & uVar16) ^ uVar56) & uVar1 ^ uVar86) & uVar37)
        ...
        ^ uVar56)
        & uVar31
        ^ (((uVar31 ^ uVar56) & uVar1 ^ uVar56 ^ uVar43) & uVar37
            ^ (uVar56 ^ uVar43) & uVar1
            ^ uVar31
            ^ uVar56)
            & uVar87
    ...
    uVar40 = !(((uVar23 ^ uVar73) & uVar39 ^ (uVar53 ^ uVar66) & uVar73 ^ uVar23 ^ uVar66)
        & uVar19)
        ^ !((uVar19 ^ uVar73) & uVar41) & uVar66
    ...
    uVar82 = !(((!uVar57 ^ uVar45 ^ uVar100) & uVar48 ^ (uVar48 ^ uVar100) & uVar82 ^ uVar45)
        & uVar44)
    ...
    uVar32 = uVar94 << 1 & !(uVar101 << 1) ^ uVar101 << 1;
    ...
    uVar62 = (!(uVar36 & uVar24) ^ uVar25 ^ uVar26) & uVar55
        ^ (uVar35 & uVar36 ^ uVar27) & uVar24
        ^ uVar25
        ^ uVar26;
    uVar11 = !uVar11;
    ...
    uVar94 = ((uVar98 ^ uVar83) & uVar74 ^ uVar4) & uVar41
        ^ (uVar41 ^ uVar11) & uVar34 & uVar98
        ^ uVar4 & uVar11
        ^ uVar19;
    uVar51 = uVar25 ^ uVar26 ^ uVar27 & uVar24;
    uVar17 = (uVar36 & uVar51 ^ uVar25 ^ uVar26 ^ uVar27 & uVar24) & uVar55
        ^ uVar35 & uVar36 & uVar51
        ^ uVar25 & !uVar26;
    uVar101 =
        !((((uVar98 & uVar83 ^ uVar4) & uVar74 ^ (uVar74 ^ uVar4) & uVar34 & uVar98 ^ uVar4)
            & uVar41
    ...
    uVar12 =
        (uVar28 & !uVar71 ^ uVar3 ^ uVar24) & uVar95 ^ (uVar71 ^ uVar3 ^ uVar24) & uVar28 ^ uVar47;
    uVar13 = ((!uVar5 ^ uVar3) & uVar47 ^ (uVar47 ^ !uVar71) & uVar28 ^ uVar3) & uVar95
        ^ (uVar28 & uVar71 ^ uVar5) & uVar47
        ^ uVar28;
    uVar24 = uVar8 ^ uVar33 ^ uVar10;
    uVar51 = !uVar8;
    uVar22 = !(((uVar50 ^ uVar33 ^ uVar10 ^ uVar51) & uVar100
        ^ (!uVar33 ^ uVar10) & uVar8
        ^ uVar50 & uVar24
        ^ uVar33)
        & uVar32)
    ...
    uVar79 = !(((uVar68 & uVar70 ^ uVar67 ^ uVar80 ^ uVar15) & uVar29
        ^ (!(!uVar23 & uVar70) ^ uVar23) & uVar80)
        & uVar81)
        ^ uVar70
        ^ uVar23;
    uVar7 = (uVar21 ^ uVar75) & uVar7;
    uVar75 = (!uVar93 & uVar69 ^ uVar21 ^ uVar75 ^ uVar7) & uVar20
        ^ (uVar21 ^ uVar75 ^ uVar93 ^ uVar7) & uVar69
        ^ uVar75;
    uVar18 = (uVar49 ^ uVar43 ^ uVar6 ^ uVar23) & uVar70 ^ uVar23;
    uVar14 = (uVar75 ^ uVar9) & uVar61;
    uVar77 = (!(((!uVar14 ^ uVar9) & uVar39 ^ uVar9 ^ uVar14) & uVar82) ^ uVar39) & uVar42
        ^ uVar9
        ^ uVar39
        ^ uVar14;
    uVar49 = (uVar32 ^ uVar50) & uVar100;
    uVar49 = (!uVar49 ^ uVar10 ^ !uVar32 & uVar50) & uVar33
        ^ (!uVar32 & uVar50 ^ uVar49) & uVar10
        ^ uVar8
        ^ uVar32;
    uVar67 = !uVar98;
    ...
    uVar32 = (!((!(uVar95 & uVar50) ^ uVar73 ^ uVar40) & uVar12) ^ uVar73 & !uVar40 ^ uVar40)
        & uVar103
        ^ !(((uVar95 ^ uVar73 ^ uVar40 ^ uVar103 & uVar50) & uVar12 ^ (uVar40 ^ uVar100) & uVar95)
            & uVar13)
    ...
    uVar93 = !(((!uVar68 ^ uVar49 ^ uVar43) & uVar24 ^ uVar68 ^ uVar49 ^ uVar43) & uVar51)
        ...
        ^ uVar68;
    uVar24 = (!((!uVar51 ^ uVar68) & uVar24) ^ (!uVar51 ^ uVar68) & uVar3 ^ uVar51 ^ uVar68)
        & uVar49
    ...
    uVar33 = ((!(uVar11 & uVar70) ^ uVar65) & uVar22
        ^ ((uVar28 ^ uVar65) & uVar70 ^ uVar22 ^ uVar65) & uVar24
        ^ uVar23)
        & uVar81
    ...
    uVar93 =
        !(((!((uVar55 ^ uVar35) & uVar65) ^ uVar55 ^ uVar35) & uVar36 ^ uVar11 & uVar55 ^ uVar24)
            & uVar22)
    ...
    uVar19 =
        (((!((uVar25 ^ uVar65) & uVar27) ^ uVar25 & uVar11 ^ uVar65) & uVar22 ^ uVar5 ^ uVar65)
            & uVar24
            ^ (!uVar5 ^ uVar65) & uVar22
            ^ uVar27)
            & uVar26
    ...
    uVar81 = !((((!uVar8 ^ uVar70) & uVar23 ^ (!uVar70 ^ uVar65) & uVar81) & uVar22
        ^ uVar47 & uVar81)
        & uVar24)
    ...
    uVar76 = !((uVar23 & uVar36 ^ uVar8 ^ uVar22 ^ uVar24) & uVar55)
        ^ !(uVar11 & uVar35 & uVar36 & uVar24) & uVar22
        ^ uVar65;
    uVar48 =
    ...
    uVar53 = ((!(uVar78 & (uVar13 ^ uVar6)) ^ uVar95 ^ uVar13) & uVar12
        ^ (!(uVar23 & uVar13) ^ uVar78) & uVar95)
        & uVar49
        ^ uVar95
        ^ uVar78;
    uVar88 = ((!((!(uVar11 & uVar98) ^ uVar65) & uVar24) ^ uVar11 & uVar98 ^ uVar65) & uVar22
        ^ uVar98
        ^ uVar24)
        & uVar74
    ...
    uVar74 = ((!uVar100 ^ uVar78 ^ uVar49) & uVar55 ^ uVar78 ^ uVar49) & uVar95
        ...
        ^ uVar78 & uVar36;
    uVar3 = !uVar17;
    uVar58 = ((uVar19 ^ uVar10 ^ uVar62 ^ uVar3) & uVar44
        ^ (uVar62 ^ uVar19) & uVar10
        ^ uVar62 & (uVar19 ^ uVar3)
        ^ uVar17)
        & uVar26
    ...
    uVar34 = !((!((uVar20 ^ uVar5) & uVar88)
        ^ (uVar20 ^ !uVar101) & uVar94
        ^ uVar46 & uVar67
        ^ uVar101)
        & uVar52)
    ...
    uVar70 =
        !((!((uVar39 & uVar59 ^ uVar55 ^ uVar100) & uVar82) ^ uVar39 ^ uVar78 ^ uVar55 ^ uVar100)
            & uVar42)
    ...
    uVar36 = ((!((!(uVar42 & uVar36) ^ uVar49) & uVar78) ^ uVar49 ^ uVar42 & uVar36) & uVar55
        ^ uVar42
        ^ uVar78)
        & uVar39
    ...
    uVar39 = !(((uVar49 & uVar27 ^ uVar9 & uVar59) & uVar61 ^ uVar9 ^ uVar55) & uVar75)
        ...
        ^ uVar23 & uVar55;
    uVar10 = !((!((uVar10 ^ uVar19 ^ uVar3) & uVar62) ^ (uVar17 ^ uVar62) & uVar44 ^ uVar17)
        & uVar26)
    ...
    uVar13 = !(((uVar58 ^ uVar76 ^ uVar47 ^ uVar93) & uVar66
        ^ (uVar76 ^ uVar47 ^ uVar93) & uVar58
        ^ uVar76
        ^ uVar47
        ^ uVar93)
        & uVar10)
    ...
    uVar19 = (uVar42 & !uVar19 ^ uVar64 & !uVar32) & uVar25
        ^ (uVar42 ^ uVar80 ^ uVar82 ^ uVar68) & uVar69
        ^ uVar64;
    ...
    uVar50 = !((!((uVar40 ^ uVar103 ^ uVar39 ^ uVar35) & uVar4) ^ uVar40 ^ uVar103 ^ uVar39)
        & uVar28)
        ^ uVar4 & uVar35
        ^ uVar40;
    ...
    uVar29 = ((uVar18 ^ uVar72 ^ uVar57 ^ !uVar29) & uVar79 ^ uVar57) & uVar48
        ^ !uVar79 & uVar57
        ^ uVar79
        ^ uVar72;
    uVar100 = (uVar19 ^ uVar73) & uVar53;
    uVar100 =
        !((uVar19 ^ uVar73 ^ uVar100) & uVar74) ^ (!uVar100 ^ uVar19 ^ uVar73) & uVar23 ^ uVar19;
    ...
    uVar27 = !(!uVar27 & uVar25) & uVar42 << 1 ^ uVar27;
    uVar23 = uVar95 << 1;
    uVar93 = !((uVar76 & uVar13) << 1) ^ uVar23;
    uVar4 = ((uVar28 ^ uVar39 ^ uVar35) & uVar4 ^ uVar39) & uVar40
        ^ !((uVar40 ^ !uVar4) & uVar103) & uVar28
        ^ uVar39 & !uVar4
        ^ uVar4;
    uVar74 = (uVar50 ^ uVar4) >> 0x1f;
    uVar47 = !(!(uVar100 << 1) & uVar19 << 1) ^ (uVar15 & uVar100) << 1;
    ...
    uVar8 = ((!uVar29 ^ uVar33) & uVar41 ^ !uVar33 & uVar29 ^ uVar33) & uVar67
        ...
        ^ uVar28 & uVar33;
    uVar9 = !((uVar42 & uVar51) << 1) & uVar25 ^ !(uVar42 << 1);
    uVar39 = (uVar70 >> 0x1f & !uVar74 ^ !(uVar50 >> 0x1f)) & 1;
    uVar10 = !(uVar13 << 1) & uVar23 ^ uVar76 << 1;
    ...
    uVar29 = (uVar19 & uVar100 ^ uVar15) << 1;
    uVar71 = !(uVar19 << 1) & uVar100 << 1 ^ uVar15 << 1;
    uVar51 = !(uVar41 << 1) & uVar8 << 1 ^ uVar83 << 1;
    uVar12 = uVar51 ^ 1;
    uVar23 = !(uVar76 << 1) & uVar13 << 1 ^ uVar23;
    ...
    uVar14 = !(uVar83 << 1) & uVar41 << 1 ^ uVar8 << 1 ^ 1;
    uVar15 = ((uVar8 ^ uVar83) & uVar41 ^ uVar83) << 1 ^ 1;
    ...
    dst[0] = ((uVar63 & 0xf66ffcff ^ uVar49 & 0x6dbf6f3f ^ 0xfbf5f7db) & uVar78
        ...
        ^ 0xa4e02313)
        & uVar21
        ^ ((uVar55 & 0x6dbf6f3f ^ 0xe0f8212f) & uVar49
            ^ uVar36 & 0xf66ffcff
            ^ uVar55 & 0xd9a0b24
            ^ 0xb92f7e67)
            & uVar78
    ...
    dst[1] = ((uVar63 & 0x3bdddfdf ^ uVar49 & 0xf7fbbdf0 ^ 0xdeeefaaf) & uVar78
        ...
        ^ 0xe152d913)
        & uVar21
        ^ ((uVar55 & 0xf7fbbdf0 ^ 0xd5e3ed73) & uVar49
            ^ (uVar36 ^ 0x2498ecc) & 0x3bdddfdf
            ^ uVar55 & 0xe5332570)
            & uVar78
    ...
    dst[2] = (((uVar77 ^ 0xfe9b5e10) & 0x9f76ffff ^ uVar19) & uVar63
        ...
        ^ 0x7fbd64ed)
        & uVar21
        ^ ((uVar55 & 0x9f76ffff ^ 0xeedf1282) & uVar49
            ^ uVar36 & 0xefbbb36d
            ^ uVar55 & 0x1264fc9b
            ^ 0x5c90dd10)
            & uVar78
    ...
    dst[6] = ((uVar72 & 0xbbbded12 ^ 0xf0a92fd4) & uVar18
        ^ (uVar65 & 0x4f56d2ef ^ 0xe6267c0b) & uVar72
        ^ 0x5e8953f1)
        & uVar79
    ...
    dst[7] = ((uVar72 & 0x61293c1 ^ 0x8e50e6e8) & uVar18
        ^ (uVar65 & 0xf9ef7d3f ^ 0xc497185b) & uVar72
        ^ 0xb306c692)
        & uVar79
    ...
    dst[8] = ((uVar72 & 0x7148003d ^ 0x5e7182f) & uVar18
        ^ (uVar65 & 0xfebfffd2 ^ 0xa6971832) & uVar72
        ^ 0x417cbb8f)
        & uVar79
    ...
    dst[9] = ((uVar94 & 0xf871aec5 ^ uVar65 & 0xfcf7bff ^ 0xf2b88430) & uVar101
        ...
        ^ (((uVar94 ^ 0xfaf9aef5) & 0xf7bed53a ^ uVar65 & 0xfcf7bff) & uVar101
            ...
            ^ 0x6b697bef)
            & uVar22
        ^ (uVar24 & 0xf871aec5 ^ uVar101 & 0xfcf7bff ^ uVar22 & 0xf7bed53a ^ 0xd07f2e05)
            & uVar46
            & uVar5
    ...
    dst[10] = ((uVar94 & 0x6d0750ca ^ uVar65 & 0xf6f8af3d ^ 0x19677fc6) & uVar101
        ...
        ^ 0xaef98c31)
        & uVar24
        ^ (((uVar94 ^ 0x19677fc6) & 0x9bfffff7 ^ uVar65 & 0xf6f8af3d) & uVar101
            ^ uVar65 & 0x296d9c41
            ^ 0xfe93cd9b)
            & uVar22
        ^ (uVar22 & 0x9bfffff7 ^ uVar24 & 0x6d0750ca ^ uVar101 & 0xf6f8af3d ^ 0xb29263b6)
            & uVar46
            & uVar5
    ...
    dst[0xb] = ((uVar94 & 0x828c813b ^ uVar65 & 0xfdffffe6 ^ 0x7125019) & uVar101
        ...
        ^ 0x7a7f2ef4)
        & uVar24
        ^ (((uVar94 ^ 0x7125019) & 0x7f737edd ^ uVar65 & 0xfdffffe6) & uVar101
            ^ uVar65 & 0xf013a395
            ^ 0xcd9c9dba)
            & uVar22
    ...
    dst[0xc] = (((uVar6 ^ 0x6605f30b) & 0xfeedf73f ^ uVar32 & 0xbbfeadf4) & uVar78
        ...
        ^ ((uVar55 & 0x45135acb ^ uVar64 & 0xbbfeadf4 ^ 0x7ae8acdb) & uVar49
            ...
            ^ 0x6ffdf10)
            & uVar78
        ^ ((uVar55 & 0xbbfeadf4 ^ 0x6605f30b) & uVar49 ^ uVar55 & 0xbbfeadf4 ^ uVar24 ^ 0x6ffdf10)
            & uVar64
    ...
    dst[0xd] = (((uVar6 ^ 0x98f92c3f) & 0xffdfffe0 ^ uVar32 & 0x67b7d3ff) & uVar78
        ...
        ^ ((uVar55 & 0x98682c1f ^ uVar64 & 0x67b7d3ff ^ 0xfbf1c81b) & uVar49
            ...
            ^ 0x651877e7)
            & uVar78
        ^ ((uVar55 & 0x67b7d3ff ^ 0x98d92c20) & uVar49 ^ uVar55 & 0x67b7d3ff ^ uVar24 ^ 0x651877e7)
            & uVar64
    ...
    dst[0xe] = (((uVar6 ^ 0xffeed7f4) & 0x43736edf ^ uVar32 & 0xfdfdff6f) & uVar78
        ...
        ^ ((uVar55 & 0xbe8e91b0 ^ uVar64 & 0xfdfdff6f ^ 0xc37d64a0) & uVar49
            ...
            ^ 0x9826c638)
            & uVar78
        ^ ((uVar55 & 0xfdfdff6f ^ 0x436246d4) & uVar49 ^ uVar55 & 0xfdfdff6f ^ uVar24 ^ 0x9826c638)
            & uVar64
    ...
    dst[0xf] = ((uVar37 & 0xff7fdb7f ^ uVar30 & 0x22e2a4a2 ^ uVar32 ^ 0xd68278e6) & uVar86
        ...
        ^ 0x1b7d1799)
        & uVar87
        ^ ((uVar56 & 0xa2e2a4a2 ^ 0x7460dc44) & uVar1
            ^ uVar69 & 0xff7fdb7f
            ^ uVar56 & 0x65f8eacc
            ^ 0xfc9fa7af)
            & uVar37
    ...
    dst[0x10] = ((uVar30 & 0x7d0d5b50 ^ uVar37 & 0xdaf2beaf ^ uVar32 ^ 0xe1fc5f39) & uVar86
        ...
        ^ 0xb306abc7)
        & uVar87
        ^ ((uVar56 & 0x7d0d5b50 ^ 0x9cf10469) & uVar1
            ^ uVar56 & 0x39fc45bc
            ^ uVar69 & 0xdaf2beaf
            ^ 0x6f6dd174)
            & uVar37
    ...
    dst[0x11] = ((uVar30 & 0x810086f ^ uVar37 & 0xf7eff7d8 ^ uVar32 ^ 0xb1fabb9) & uVar86
        ...
        ^ 0xfee7f53b)
        & uVar87
        ^ ((uVar56 & 0x810086f ^ 0x30fa3d6) & uVar1
            ^ uVar56 & 0x4df84ee1
            ^ uVar69 & 0xf7eff7d8
            ^ 0x2ff168f7)
            & uVar37
    ...
    dst[0x15] = ((uVar74 ^ 0x4b59a0f0) & uVar93 ^ uVar49 & 0x7bdde4ff ^ 0x8e7a9b06) & uVar39
        ^ ((uVar50 ^ uVar74 ^ 0xbcf7dfbf) & uVar23
            ^ (uVar50 ^ 0x8f191b20) & uVar74
            ^ uVar32 & 0xf7ae7f4f
            ^ 0xb1e6c599)
            & uVar34
    ...
    dst[0x16] = ((uVar74 ^ 0xba8cd6b8) & uVar34
        ^ (uVar74 ^ 0xba8cd6b8) & uVar93
        ^ uVar49 & 0xbeeffff8
        ^ 0x613631f7)
        & uVar39
        ^ ((uVar50 ^ 0xe7ff3947) & uVar23
            ^ (uVar50 ^ 0x5eb066de) & uVar74
            ^ uVar32 & 0x5d73efff
            ^ 0xbd4d5e2e)
            & uVar34
    ...
    dst[0x17] = ((uVar74 ^ 0x34626d07) & uVar34
        ^ uVar93 & 0x34626d07
        ^ uVar49 & 0xff7affb7
        ^ uVar74
        ^ 0x99afecf8)
        & uVar39
        ^ ((uVar50 ^ uVar74 ^ 0xdbbfffff) & uVar23
            ^ (uVar50 ^ 0x60568029) & uVar74
            ^ uVar32 & 0xefdd92f8
            ^ 0x72707f46)
            & uVar34
    ...
    dst[0x18] = ((uVar68 ^ uVar12 & 0xbbbded12 ^ uVar45 ^ 0xe6267c0b) & uVar14
        ...
        ^ 0x51e22a86;
    dst[0x19] =
        ((uVar12 & 0x61293c1 ^ uVar68 ^ 0xc497185b) & uVar14 ^ uVar12 & 0x4ac7feb3 ^ 0xf5914d40)
            & uVar15
            ...
            ^ 0xd0df58dc;
    dst[0x1a] = ((uVar12 & 0x7148003d ^ uVar45 ^ 0xa6971832) & uVar14
        ^ (uVar45 ^ 0xa370001d) & uVar12
        ^ uVar49
        ^ 0xd26cbb87)
        & uVar15
    ...
    dst[0x1b] = (uVar27 & 0xd07f2e05 ^ uVar32 ^ 0x9fd9f7be) & uVar20
        ^ (uVar32 ^ 0x9fd9f7be) & uVar27
        ^ uVar49 & 0xd07f2e05
        ^ 0x97eb6e0b;
    dst[0x1c] = (uVar27 & 0xb29263b6 ^ uVar9 & 0xdf95337c ^ uVar49 & 0x6d0750ca ^ 0x716cbf4d)
        & uVar20
        ^ (uVar9 & 0xdf95337c ^ uVar49 & 0x6d0750ca ^ 0x716cbf4d) & uVar27
        ^ uVar49 & 0xb29263b6
        ^ 0xce03ee6;
    dst[0x1d] = (uVar27 & 0x8f60dd48 ^ uVar9 & 0xdec5c72 ^ uVar49 & 0x828c813b ^ 0x77937287)
        & uVar20
    ...
    dst[0x21] = ((uVar13 ^ 0x11983688) & uVar100
        ^ uVar49
    ...
    dst[0x22] = (((uVar13 ^ 0xfd0d5bd5) & uVar100 ^ uVar49) & 0xa7ffe5ff
        ...
        ^ uVar100 & 0xf39cd51d
        ^ 0x435c6204;
    dst[0x23] = ((uVar13 ^ 0x4ef7ed37) & uVar100
        ^ uVar49
        ...
        ^ ((uVar13 ^ 0x4ef7ed37) & uVar100
            ^ (uVar100 & 0xf7eff7d8 ^ 0xb1fabb9) & uVar60
            ^ 0xfde856ed)
            & uVar38
